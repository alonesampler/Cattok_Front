    ...
    return (
        <>
            <div id = "TopNav" className="fixed bg-white z-30 flex items-center w-full border-b h-[60px]">
                <div className={`flex items-center justify-between gap-6 w-full px-4 mx-auto ${pathname === '/' ? 'max-w-[1150px]' : 'max-w-[1150px]'}`}>
                    <Link href="/">
                        <img className="min-w-[115px] w-[115px]" src="/images/cattok-logo.png"/>
                    </Link>
                    ...
                    <div className = "relative hidden md:flex items-center justify-end bg-[#F1F1F2] p-1 rounded-full max-w-[430px] w-full">
                        ...
                        {/* <div className="absolute bg-white max-w-[910px] h-auto w-full z-20 left-0 top-12 border p-1">
                            <div className="p-1">
                                <Link
                                    href = {`/profile/1`}
                                    className="flex items-center justify-between w-full cursor-pointer hover:bg-[#00BFFF] p-1 px-2 hover:text-white"
                                >
                                    <div className="flex items-center">
                                        <img className="rounded-md" width="40" src="https://placehold.co/40"/>
                                        <div className="truncate ml-2">Adam Bread</div>
                                    </div>
                                </Link>
                            </div>
                        </div> */}
                   ...
                   <div className="flex items-center gap-3">
                        ...
                        {true ? (
                            <div className="flex items-center">
                                <button
                                    className="flex items-center bg-[#838383] text-white border rounded-md px-3 py-[6px]"
                                >
