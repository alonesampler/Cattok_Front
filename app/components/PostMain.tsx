    ...
    useEffect(() => {
        ...
        if(postMainElement){
            let observer = new IntersectionObserver((entities) => {
                entities[0].isIntersecting ? video.play() : video.pause()
            }, {threshold: [0.6] })
        ...
        <>
            <div id={`PostMain-${post.id}`} className="flex border-b py-6">
                ...
                <div className="pl-3 w-full px-4">
                    ...
                    <p className="text-[15px] pb-0.5 break-words bold md:max-w-[400px] max-w-[300px]">{post.text}</p>
                    <p className="text-blue-500 pb-0.5">#fun #cool #HAHAHAHAH</p>
                    <p className="text-[14px] pb-0.5 flex items-center font-sem ibold">
                        <ImMusic size="17"/>
                    ...
                    <div className="mt-2.5 flex">
                        <div className="relative min-h-[480px] max-h-[580px] max-w-[310px] flex items-center bg-black rounded-xl cursor-pointer">
                            ...
                            <img
                                ...
                                width="90"
                                src="/images/cattok-logo-white.png"
                            />
                        </div>
