                ...
                <div className="pt-[90px] ml-[90px] 2xl:pl-[185px] lg:pl-[160px] lg:pr-0 w-[calc(100%-90px)] pr-3 max-w-[1800px] 2xl:mx-auto">
                    <div className="flex w-[calc(100vw-230px)]">
                        ...
                        <div className="ml-5 w-full">
                            ...
                            {true ? (
                                <button
                                    className="flex items-center rounded-md py-1.5 px-3.5 mt-3 text-[15px] font-bold border hover:bg-gray-100"
                                >
                                ...
                                <button
                                    className="flex items-center rounded-md py-1.5 px-8 mt-3 text-[15px] text-white font-bold bg-[#F02C56]"
                                >
                                    Follow
                                </button>
                            )}
                    ...
                    <div className="flex items-center pt-4">
                        <div className="mr-4">
                            ...
                            <span className="text-gray-500 font-ligth text-[15px] pl-1.5">Following</span>
                        </div>

                        <div className="mr-4">
                            <span className="font-bold">44K</span>
                            <span className="text-gray-500 font-ligth text-[15px] pl-1.5">Followers</span>
                        </div>
                    </div>
                    ...
                    <ul className="w-full flex items-center pt-4 border-b">
                        <li className="w-60 text-center py-2 text-[17px] font-bold border-b-2 border-b-black">Videos</li>
                        <li className="w-60 text-gray-500 text-center py-2 text-[17px] font-bold">Likes</li>
                    </ul>
